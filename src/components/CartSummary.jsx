...
const CartSummary = () => {
    ...
    <div>
        <div className="bg-stone-50 rounded-xl p-6 shadow-md h-fit">
            ...
            <div className="flex justify-between etxt-gray-600">
            ...
            <form action="" className="py-2">
                ...
                className="py-2 px-4 broder border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-stone-500 shadow-sm text-sm sm:text-base"
                required />
